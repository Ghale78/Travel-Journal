...
const Box = () => {
    const {height, width, backgroundColor, borderRadius, right,top,bottom } = 
  ...
  return (
    <div className='flex items-center flex-col p-20'>
      <div style={{backgroundColor, height, width, borderRadius, right,top,bottom, position:'relative' }}>
      </div>
      {generateArea()}
